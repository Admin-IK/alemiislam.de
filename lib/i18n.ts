...
const messages = {
  de: {
    ...
    mitglieder: {
      ...
      intro:
        "Bitte geben Sie Ihre Daten ein, damit wir Ihr Profil in EasyVerein finden und anzeigen können. Alle Angaben werden vertraulich behandelt.",
      vorname: "Vorname",
      nachname: "Nachname",
      ...
      plz: "PLZ",
      ort: "Ort",
      kindname: "Name eines Kindes (optional)",
      placeholderVorname: "z. B. Mehmet",
      placeholderNachname: "z. B. Yılmaz",
      placeholderTelefon: "z. B. 0176 12345678",
      placeholderStrasse: "z. B. Musterstr. 12",
      placeholderOrt: "Ludwigshafen",
      placeholderKind: "Falls vorhanden, z. B. Ayşe",
      searching: "Wird gesucht …",
      searchBtn: "Profil suchen",
      notFound:
      ...
      profileTitle: "Profil prüfen & ergänzen",
      profileIntro:
        "Wir haben Ihr Profil gefunden. Bitte prüfen Sie die Daten und ergänzen Sie die fehlenden Angaben.",
      storedData: "Hinterlegte Daten",
      memberNr: "Mitgliedsnr.",
      address: "Adresse",
      email: "E-Mail",
      birthdate: "Geburtsdatum",
      missingTitle: "Fehlende Angaben ergänzen",
      missingIntro:
        "Diese Informationen werden für Ihren EasyVerein-Login benötigt.",
      emailLabel: "E-Mail-Adresse (für Login)",
      placeholderEmail: "ihre.email@beispiel.de",
      passwordLabel: "Passwort (für Login)",
      passwordConfirmLabel: "Passwort bestätigen",
      placeholderPassword: "Min. 8 Zeichen",
      placeholderPasswordConfirm: "Nochmal eingeben",
      birthdateLabel: "Geburtsdatum",
      passwordMismatch: "Die Passwörter stimmen nicht überein.",
      passwordTooShort:
        "Das Passwort muss mindestens 8 Zeichen lang sein.",
      ibanInvalidFormat:
        "Ungültiges IBAN-Format. Bitte prüfen Sie Ihre Eingabe.",
      ibanWrongLength:
        "Eine {country}-IBAN muss {expected} Zeichen haben (eingegeben: {actual}).",
      ibanInvalidChecksum:
        "Die IBAN-Prüfziffer ist ungültig. Bitte überprüfen Sie die Nummer.",
      saving: "Wird gespeichert …",
      saveBtn: "Daten speichern & weiter",
      saveError: "Fehler beim Speichern. Bitte erneut versuchen.",
      bankTitle: "Bankverbindung (Lastschriftverfahren)",
      bankIntro:
        "Für den Mitgliedsbeitrag per SEPA-Lastschrift. Mandatsreferenz und Mandatsdatum werden automatisch gesetzt.",
      iban: "IBAN",
      bic: "BIC",
      accountHolder: "Kontoinhaber",
      placeholderIban: "z. B. DE89 3704 0044 0532 0130 00",
      placeholderBic: "z. B. COBADEFFXXX",
      placeholderHolder: "Vor- und Nachname",
      mandateRef: "Mandatsreferenz:",
      mandateDate: "Mandatsdatum:",
      doneTitle: "Daten erfolgreich gespeichert",
      doneIntro:
        "Ihre Daten wurden aktualisiert. Nutzen Sie die folgende Anleitung, um sich bei EasyVerein einzuloggen.",
      loginGuideTitle: "Anleitung: Bei EasyVerein einloggen",
      loginStep1: "Öffnen Sie:",
      loginStep2: "Geben Sie als {bold}Vereinskürzel{/bold} ein:",
      loginStep3Email:
        "Geben Sie Ihre {bold}E-Mail-Adresse{/bold} und das {bold}Passwort{/bold} ein, das Sie soeben gewählt haben.",
      loginStep4: 'Klicken Sie auf \u201EAnmelden\u201C.',
      appTitle: "EasyVerein App installieren",
      appIntro:
        "Sie können auch bequem über die App auf Ihr Mitgliederprofil zugreifen. Verwenden Sie beim Login das Vereinskürzel {bold}AlemiIslam{/bold}.",
      android: "Android (Google Play)",
      ios: "iPhone / iPad (App Store)",
      important:
        "Das Vereinskürzel lautet immer {bold}AlemiIslam{/bold} (ohne Leerzeichen, Groß-/Kleinschreibung beachten). Sollten Sie Probleme beim Login haben, wenden Sie sich bitte an",
      orCall: "oder rufen Sie uns an unter",
    ...
    admin: {
      ...
      overviewTitle: "Mitglieder-Übersicht",
      ...
      update1: "Aktualisierung",
      noActivity: "Keine Aktivität in den letzten 7 Tagen.",
      status: "Status",
      nr: "Nr.",
      name: "Name",
      phone: "Telefon",
      ...
      never: "Nie",
      noMembers: "Keine Mitglieder in dieser Kategorie.",
      asOf: "Stand:",
  ...
  tr: {
    ...
    mitglieder: {
      title: "Üye Bilgi Güncelleme",
      intro:
        "EasyVerein'deki profilinizi bulabilmemiz için lütfen bilgilerinizi girin. Tüm bilgiler gizli tutulacaktır.",
      vorname: "Ad",
      nachname: "Soyad",
      ...
      plz: "Posta kodu",
      ort: "Şehir",
      kindname: "Çocuğun adı (isteğe bağlı)",
      placeholderVorname: "ör. Mehmet",
      placeholderNachname: "ör. Yılmaz",
      placeholderTelefon: "ör. 0176 12345678",
      placeholderStrasse: "ör. Musterstr. 12",
      placeholderOrt: "Ludwigshafen",
      placeholderKind: "Varsa, ör. Ayşe",
      searching: "Aranıyor …",
      searchBtn: "Profil ara",
      notFound:
        "Üye bulunamadı. Lütfen bilgilerinizi kontrol edin.",
      connectionError:
        "Bağlantı hatası. Lütfen daha sonra tekrar deneyin.",
      profileTitle: "Profili kontrol et ve tamamla",
      profileIntro:
        "Profilinizi bulduk. Lütfen bilgileri kontrol edin ve eksik bilgileri tamamlayın.",
      storedData: "Kayıtlı bilgiler",
      memberNr: "Üye no.",
      address: "Adres",
      email: "E-posta",
      birthdate: "Doğum tarihi",
      missingTitle: "Eksik bilgileri tamamlayın",
      missingIntro:
        "Bu bilgiler EasyVerein girişiniz için gereklidir.",
      emailLabel: "E-posta adresi (giriş için)",
      placeholderEmail: "e-posta@ornek.com",
      passwordLabel: "Şifre (giriş için)",
      passwordConfirmLabel: "Şifreyi onayla",
      placeholderPassword: "En az 8 karakter",
      placeholderPasswordConfirm: "Tekrar girin",
      birthdateLabel: "Doğum tarihi",
      passwordMismatch: "Şifreler uyuşmuyor.",
      passwordTooShort: "Şifre en az 8 karakter olmalıdır.",
      ibanInvalidFormat:
        "Geçersiz IBAN formatı. Lütfen girişinizi kontrol edin.",
      ibanWrongLength:
        "{country}-IBAN {expected} karakter olmalıdır (girilen: {actual}).",
      ibanInvalidChecksum:
        "IBAN kontrol rakamı geçersiz. Lütfen numarayı kontrol edin.",
      saving: "Kaydediliyor …",
      saveBtn: "Kaydet ve devam et",
      saveError: "Kaydetme hatası. Lütfen tekrar deneyin.",
      bankTitle: "Banka bilgileri (otomatik ödeme)",
      bankIntro:
        "Üyelik aidatı için SEPA otomatik ödeme talimatı. Mandato referansı ve tarihi otomatik olarak ayarlanır.",
      iban: "IBAN",
      bic: "BIC",
      accountHolder: "Hesap sahibi",
      placeholderIban: "ör. DE89 3704 0044 0532 0130 00",
      placeholderBic: "ör. COBADEFFXXX",
      placeholderHolder: "Ad ve soyad",
      mandateRef: "Mandato referansı:",
      mandateDate: "Mandato tarihi:",
      doneTitle: "Bilgiler başarıyla kaydedildi",
      doneIntro:
        "Bilgileriniz güncellendi. EasyVerein'e giriş yapmak için aşağıdaki talimatları takip edin.",
      loginGuideTitle: "Kılavuz: EasyVerein'e giriş yapın",
      loginStep1: "Şu adresi açın:",
      loginStep2: "{bold}Dernek kısaltması{/bold} olarak girin:",
      loginStep3Email:
        "{bold}E-posta adresinizi{/bold} ve az önce belirlediğiniz {bold}şifrenizi{/bold} girin.",
      loginStep4: '\u201EGiri\u015F yap\u201C d\u00FC\u011Fmesine t\u0131klay\u0131n.',
      appTitle: "EasyVerein uygulamasını yükleyin",
      appIntro:
        "Üye profilinize uygulama üzerinden de ulaşabilirsiniz. Giriş yaparken dernek kısaltması olarak {bold}AlemiIslam{/bold} kullanın.",
      android: "Android (Google Play)",
      ios: "iPhone / iPad (App Store)",
      important:
        "Dernek kısaltması her zaman {bold}AlemiIslam{/bold} şeklindedir (boşluksuz, büyük/küçük harfe dikkat edin). Giriş yapamıyorsanız lütfen",
      orCall: "adresine yazın veya bizi arayın:",
      backHome: "← Ana sayfaya",
    },
    admin: {
      title: "Yönetici Paneli",
      loginIntro: "Üye listesini görmek için şifre girin.",
      passwordLabel: "Yönetici şifresi",
      loginBtn: "Giriş yap",
      loading: "Yükleniyor …",
      accessDenied: "Erişim reddedildi.",
      overviewTitle: "Üye Genel Bakışı",
      refresh: "Yenile",
      ...
      updates: "güncelleme",
      update1: "güncelleme",
      noActivity: "Son 7 günde herhangi bir aktivite yok.",
      status: "Durum",
      nr: "No.",
      name: "İsim",
      phone: "Telefon",
